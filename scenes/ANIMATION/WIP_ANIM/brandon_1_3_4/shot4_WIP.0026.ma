...
//Name: shot4_WIP.0026.ma
//Last modified: Wed, Nov 11, 2020 02:47:05 PM
//Codeset: 1252
...
fileInfo "UUID" "3F1EFBAA-4EEF-7461-13B4-05ACC444029A";
createNode transform -s -n "persp";
	rename -uid "589C33C5-4443-CDAD-A4C7-87A98D7BAD94";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.8050541848211534 1.5987010636271559 -2.9914595114502518 ;
	setAttr ".r" -type "double3" -11.138352730115733 94.999999999928221 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "3B2BE92D-4556-A4BB-3ABE-33B0F4C61043";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 1000000;
	setAttr ".coi" 6.7996058915229369;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BE4EDC75-499F-907E-96A4-098566C8AAE6";
	setAttr -s 122 ".lnk";
	setAttr -s 122 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9D449897-49C3-B387-1B4A-99A396A4FF88";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "8B099599-40FF-FB42-54DE-AABF32EDEE5B";
createNode displayLayerManager -n "layerManager";
	rename -uid "D5B59D53-4BC6-D80E-AB9A-8FB9C772CA72";
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
createNode displayLayer -n "defaultLayer";
	rename -uid "7CEF1A4F-47B1-FDF9-4BFA-8A8A0C928C9A";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "E8726057-4A6F-E131-5289-578B2E6E6495";
...
createNode reference -n "goodGuy_rigRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"visibility" " 1"
		2 "|goodGuy_rig:Group|goodGuy_rig:Main|goodGuy_rig:MotionSystem|goodGuy_rig:IKSystem|goodGuy_rig:IKHandle|goodGuy_rig:IKOffsetLeg_R|goodGuy_rig:IKExtraLeg_R|goodGuy_rig:IKLeg_R" 
		"translate" " -type \"double3\" 0 0 0.28"
		2 "|goodGuy_rig:Group|goodGuy_rig:Main|goodGuy_rig:MotionSystem|goodGuy_rig:IKSystem|goodGuy_rig:IKHandle|goodGuy_rig:IKOffsetLeg_R|goodGuy_rig:IKExtraLeg_R|goodGuy_rig:IKLeg_R" 
		"translateX" " -av"
		2 "|goodGuy_rig:Group|goodGuy_rig:Main|goodGuy_rig:MotionSystem|goodGuy_rig:IKSystem|goodGuy_rig:IKHandle|goodGuy_rig:IKOffsetLeg_R|goodGuy_rig:IKExtraLeg_R|goodGuy_rig:IKLeg_R" 
		"translateY" " -av"
		...
		"visibility" " 1"
		2 "|goodGuy_rig:Group|goodGuy_rig:Main|goodGuy_rig:MotionSystem|goodGuy_rig:IKSystem|goodGuy_rig:IKHandle|goodGuy_rig:IKOffsetLeg_L|goodGuy_rig:IKExtraLeg_L|goodGuy_rig:IKLeg_L" 
		"translate" " -type \"double3\" -0.043754083973180258 0 -0.29748563854825882"
		2 "|goodGuy_rig:Group|goodGuy_rig:Main|goodGuy_rig:MotionSystem|goodGuy_rig:IKSystem|goodGuy_rig:IKHandle|goodGuy_rig:IKOffsetLeg_L|goodGuy_rig:IKExtraLeg_L|goodGuy_rig:IKLeg_L" 
		"translateX" " -av"
		2 "|goodGuy_rig:Group|goodGuy_rig:Main|goodGuy_rig:MotionSystem|goodGuy_rig:IKSystem|goodGuy_rig:IKHandle|goodGuy_rig:IKOffsetLeg_L|goodGuy_rig:IKExtraLeg_L|goodGuy_rig:IKLeg_L" 
		"translateY" " -av"
...
createNode animCurveTL -n "IKLeg_R_translateY";
	...
	setAttr ".tan" 18;
	setAttr -s 8 ".ktv[0:7]"  1 0 10 0 15 0.34520267235228375 20 0 45 0
		 50 0.345 55 0 80 0;
	setAttr -s 8 ".kit[2:7]"  1 18 18 18 18 18;
	setAttr -s 8 ".kot[2:7]"  1 18 18 18 18 18;
	setAttr -s 8 ".kix[2:7]"  0.16666666666666669 0.20833333333333337 
		1.0416666666666665 0.20833333333333348 0.20833333333333304 1.041666666666667;
	setAttr -s 8 ".kiy[2:7]"  0 0 0 0 0 0;
	setAttr -s 8 ".kox[2:7]"  0.16666666666666669 1.0416666666666665 
		0.20833333333333348 0.20833333333333304 1.041666666666667 1.041666666666667;
...
createNode animCurveTL -n "IKLeg_R_translateZ";
	...
	setAttr ".tan" 18;
	setAttr -s 8 ".ktv[0:7]"  1 -0.13 20 0.279 40 -0.13 60 0.28 80 -0.13966091409386389
		 100 0.2900718619382528 120 -0.12231309506141974 140 0.29007186193825285;
	setAttr -s 8 ".kit[2:7]"  1 18 18 18 18 18;
	setAttr -s 8 ".kot[2:7]"  1 18 18 18 18 18;
	setAttr -s 8 ".kix[2:7]"  0.75690469457083864 0.83333333333333326 
		0.83333333333333348 0.83333333333333348 0.83333333333333304 0.83333333333333304;
	setAttr -s 8 ".kiy[2:7]"  -0.049965819597620954 0 0 0 0 0;
	setAttr -s 8 ".kox[2:7]"  0.75690475707235905 0.83333333333333348 
		0.83333333333333348 0.83333333333333304 0.83333333333333304 0.83333333333333304;
	setAttr -s 8 ".koy[2:7]"  -0.049965787986284843 0 0 0 0 0;
createNode animCurveTL -n "IKLeg_L_translateZ";
	rename -uid "C2DC099B-4797-622F-FCDD-A38ABB1F5BAE";
	setAttr ".tan" 18;
	setAttr -s 4 ".ktv[0:3]"  1 0.25 20 -0.30797841130854875 40 0.26451753507136794
		 60 -0.29748563854825882;
	setAttr -s 4 ".kit[2:3]"  1 18;
	setAttr -s 4 ".kot[2:3]"  1 18;
	setAttr -s 4 ".kix[2:3]"  0.66187180634831089 0.83333333333333326;
	setAttr -s 4 ".kiy[2:3]"  -0.0011792076416709632 0;
	setAttr -s 4 ".kox[2:3]"  0.66187183127834182 0.83333333333333326;
	setAttr -s 4 ".koy[2:3]"  -0.0011791635491831701 0;
