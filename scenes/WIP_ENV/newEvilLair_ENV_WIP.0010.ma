...
//Name: newEvilLair_ENV_WIP.0010.ma
//Last modified: Tue, Nov 03, 2020 03:31:13 PM
//Codeset: 1252
...
fileInfo "UUID" "9BD71F01-493D-48D2-70CB-9DB1BF16BF24";
createNode transform -s -n "persp";
	rename -uid "71DF941A-4172-4055-0B6C-0AAF6640B8FF";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -6.0988710416851406 19.683614708189445 9.8561838035203237 ;
	setAttr ".r" -type "double3" -51.338352729695565 340.59999999983313 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "369DB1E5-49FE-EC23-766C-85B92232F289";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 1000000;
	setAttr ".coi" 22.791173904461015;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D70AB644-4CC2-9892-0238-3EA93AB25327";
	setAttr -s 30 ".lnk";
	setAttr -s 30 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "D30312D2-4121-2C40-9EAB-D6B962D32B62";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "FB39DBA8-4CEE-E5B4-F0E9-78970F220D1E";
createNode displayLayerManager -n "layerManager";
	rename -uid "A9718C97-4212-8CDD-CFF8-9AB64F91D9B7";
	setAttr ".cdl" 1;
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "BFFF81AF-4246-3125-7AA0-7DA93CB6B8E4";
...
createNode reference -n "bookcaseRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|leftSide_bookcases_grp|bookcase:BOOKSHELF_GROUP" "translate" " -type \"double3\" -11.34817176095958757 0 -3.08636535835715708"
		
		2 "|leftSide_bookcases_grp|bookcase:BOOKSHELF_GROUP" "rotate" " -type \"double3\" 0 -90 0"
...
createNode reference -n "bookcaseRN1";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|leftSide_bookcases_grp|bookcase1:BOOKSHELF_GROUP" "translate" " -type \"double3\" -11.34006231320375946 0 -0.58134765272434263"
		
		2 "|leftSide_bookcases_grp|bookcase1:BOOKSHELF_GROUP" "rotate" " -type \"double3\" 0 -90 0"
...
createNode reference -n "bookcaseRN2";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|leftSide_bookcases_grp|bookcase2:BOOKSHELF_GROUP" "translate" " -type \"double3\" -11.35942132337428845 0 2.1410870993519735"
		
		2 "|leftSide_bookcases_grp|bookcase2:BOOKSHELF_GROUP" "rotate" " -type \"double3\" 0 -90 0"
...
// End of newEvilLair_ENV_WIP.0010.ma
