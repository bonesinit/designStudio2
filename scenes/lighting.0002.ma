...
//Name: lighting.0002.ma
//Last modified: Fri, Nov 06, 2020 11:44:37 AM
//Codeset: 1252
...
fileInfo "UUID" "8DD7CC09-4AAB-E278-736C-5590CD6EE713";
createNode transform -s -n "persp";
	rename -uid "F0644C6A-4262-38FA-08D6-3BA723F55F9D";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.5699909455645966 27.346847402557376 10.874271050268037 ;
	setAttr ".r" -type "double3" -66.938352729919743 -1093.7999999996841 -8.1877314683896298e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "816FF9A1-4E9F-8AB1-8B65-F9A38122D87B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 28.6841677575466;
...
createNode transform -n "render_cam";
	...
	setAttr ".t" -type "double3" -3.4902817602919103 4.7738685557778631 9.7389665705248536 ;
	setAttr ".r" -type "double3" -14.738352729602139 -372.99999999998727 4.0802704183091785e-16 ;
createNode camera -n "render_camShape" -p "render_cam";
	...
	setAttr ".ovr" 1.3;
	setAttr ".fl" 18;
	setAttr ".coi" 9.9743103172625229;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1C215EEC-4E2A-976E-6923-908FC62431EA";
	setAttr -s 50 ".lnk";
	setAttr -s 50 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "497DD9DB-465A-AFD5-A0FB-03A9CAE6D8A4";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "DC4845C2-4D8D-967A-080B-20880CC6AB97";
createNode displayLayerManager -n "layerManager";
	rename -uid "A29558BD-4A4A-F78D-B2BA-2684B227738F";
createNode displayLayer -n "defaultLayer";
	rename -uid "EEDE5955-4BEB-F809-BE15-4C9D05C8E6F9";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "FE79F3B0-41C5-70BF-0CB2-328298784DE1";
...
createNode reference -n "newEvilLair_envRN1";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"newEvilLair_env_reup:paintingRN" 4
		2 "|newEvilLair_env_reup:all_wallArt_grp|newEvilLair_env_reup:painting:painting_grp|newEvilLair_env_reup:painting:POSITION|newEvilLair_env_reup:painting:MOVEMENT|newEvilLair_env_reup:painting:ADJUSTMENTS|newEvilLair_env_reup:painting:DO_NOT_TOUCH|newEvilLair_env_reup:painting:painting_geo|newEvilLair_env_reup:painting:painting_geoShape" 
		"instObjGroups.objectGroups" " -s 2"
		3 "newEvilLair_env_reup:painting:groupId2.groupId" "|newEvilLair_env_reup:all_wallArt_grp|newEvilLair_env_reup:painting:painting_grp|newEvilLair_env_reup:painting:POSITION|newEvilLair_env_reup:painting:MOVEMENT|newEvilLair_env_reup:painting:ADJUSTMENTS|newEvilLair_env_reup:painting:DO_NOT_TOUCH|newEvilLair_env_reup:painting:painting_geo|newEvilLair_env_reup:painting:painting_geoShape.instObjGroups.objectGroups[1].objectGroupId" 
		""
		3 "|newEvilLair_env_reup:all_wallArt_grp|newEvilLair_env_reup:painting:painting_grp|newEvilLair_env_reup:painting:POSITION|newEvilLair_env_reup:painting:MOVEMENT|newEvilLair_env_reup:painting:ADJUSTMENTS|newEvilLair_env_reup:painting:DO_NOT_TOUCH|newEvilLair_env_reup:painting:painting_geo|newEvilLair_env_reup:painting:painting_geoShape.instObjGroups.objectGroups[1]" 
		":defaultLastHiddenSet.dagSetMembers" "-na"
		3 "newEvilLair_env_reup:painting:groupId2.message" ":defaultLastHiddenSet.groupNodes" 
		"-na";
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "blue_lightShape__LEItem.en" "blueAreaRight_lightShape.v";
connectAttr "blue_light1Shape__LEItem.en" "blueAreaLeft_lightShape.v";
...
connectAttr "aiAreaLight6Shape__LEItem.en" "mapLow_lightShape.v";
connectAttr "aiAreaLight3Shape__LEItem.en" "bookshelfLeft_lightShape.v";
...
connectAttr "mapLow_lightShape.msg" "aiAreaLight6Shape__LEItem.lgt";
...
connectAttr "blueAreaLeft_lightShape.msg" "blue_light1Shape__LEItem.lgt";
...
connectAttr "blueAreaRight_lightShape.msg" "blue_lightShape__LEItem.lgt";
...
connectAttr "bookshelfLeft_lightShape.msg" "aiAreaLight3Shape__LEItem.lgt";
