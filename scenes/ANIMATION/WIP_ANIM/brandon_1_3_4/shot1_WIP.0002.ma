...
//Name: shot1_WIP.0002.ma
//Last modified: Sun, Nov 15, 2020 11:41:49 AM
//Codeset: 1252
...
fileInfo "UUID" "BD58DB38-4FC9-F5BD-B99F-4DB204E2273D";
createNode transform -s -n "persp";
	rename -uid "25C0C092-40D1-AAF0-F904-9C8D9FF12C3F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.87483400001879574 6.3779501369349543 8.9192283540353703 ;
	setAttr ".r" -type "double3" -18.338352729560224 18.599999999979392 -8.3895882366214411e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "EE30F8B5-425E-8E9F-2A7D-CF87E1A825D7";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 1000000;
	setAttr ".coi" 7.3807981139559899;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -9.5868607354089406 2.4388402407854102 9.9197882574801284 ;
...
createNode transform -n "pointLight1";
	rename -uid "8D899046-498F-8C80-A3AC-048EA10CED9A";
	setAttr ".t" -type "double3" -9.884898786174432 2.1908032839048568 1.5716195893932063 ;
	setAttr ".s" -type "double3" 2.8367029566796935 2.8367029566796935 2.8367029566796935 ;
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	rename -uid "CBA1CA19-42AE-C0F4-F152-5391D1C9689D";
	setAttr -k off ".v";
	setAttr ".in" 7.4447951316833496;
	setAttr ".us" no;
	setAttr ".ai_exposure" 3.952380895614624;
...
createNode reference -n "newEvilLair_envRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 0 20.82350617283951166 0"
		2 "|newEvilLair_env:all_doorsWindows_grp|newEvilLair_env:sideDoor:sideDoor_grp|newEvilLair_env:sideDoor:POSITION|newEvilLair_env:sideDoor:MOVEMENT|newEvilLair_env:sideDoor:ADJUSTMENT|newEvilLair_env:sideDoor:DO_NOT_TOUCH|newEvilLair_env:sideDoor:door_ctrl" 
		"rotateY" " -av"
