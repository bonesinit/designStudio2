...
//Name: lighting.0006.ma
//Last modified: Fri, Nov 06, 2020 01:18:31 PM
//Codeset: 1252
...
file -rdi 2 -ns "envRender_lightsCams" -dr 1 -rfn "newEvilLair_env_reup:envRender_lightsCamsRN"
...
fileInfo "UUID" "DF4CA69C-4649-2DC0-8190-3486D7ECCC36";
createNode transform -s -n "persp";
	rename -uid "F0644C6A-4262-38FA-08D6-3BA723F55F9D";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.2803789968293868 24.17091475805497 14.794190993671933 ;
	setAttr ".r" -type "double3" -39.93835273009767 -698.99999999992372 8.5170880601005051e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "816FF9A1-4E9F-8AB1-8B65-F9A38122D87B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 15.085364427475191;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D17342FD-445E-F104-EF30-4EBD8CBABBCB";
	setAttr -s 50 ".lnk";
	setAttr -s 50 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "856075A6-43AA-4F39-3BFB-D6BA65857B76";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "FB394D90-4CE1-9B59-779D-BC9578F0D62E";
createNode displayLayerManager -n "layerManager";
	rename -uid "B0F79CD4-4BCB-B8C7-276F-50B125B3CEB3";
createNode displayLayer -n "defaultLayer";
	rename -uid "EEDE5955-4BEB-F809-BE15-4C9D05C8E6F9";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5FCD7178-4AC0-F811-60BC-B8807D63A15D";
...
createNode reference -n "newEvilLair_envRN1";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"newEvilLair_envRN1" 1
		2 "|newEvilLair_env_reup:all_lightingCams_grp" "visibility" " 0";
