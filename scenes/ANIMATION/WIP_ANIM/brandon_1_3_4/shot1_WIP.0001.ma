...
//Name: shot1_WIP.0001.ma
//Last modified: Sun, Nov 15, 2020 11:35:35 AM
//Codeset: 1252
...
fileInfo "UUID" "46BB30FE-472A-5DFD-5FE5-E68141B01732";
createNode transform -s -n "persp";
	rename -uid "25C0C092-40D1-AAF0-F904-9C8D9FF12C3F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.9552810396257421 30.576206076522617 -7.900121466506274 ;
	setAttr ".r" -type "double3" -67.538352729561765 142.19999999999413 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "EE30F8B5-425E-8E9F-2A7D-CF87E1A825D7";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 1000000;
	setAttr ".coi" 24.490976109240606;
...
createNode camera -n "shot1_camShape" -p "shot1_cam";
	...
	setAttr ".ff" 0;
	setAttr ".coi" 1.0121414505148456;
	setAttr ".ow" 30;
...
createNode animCurveTA -n "door_ctrl_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  95 0 98 12.000000000000002 100 12.000000000000002
		 105 23.621693342282381;
select -ne :time1;
	setAttr ".o" 100;
	setAttr ".unw" 100;
...
connectAttr "shot1_cam_translateX.o" "shot1_cam.tx";
connectAttr "shot1_cam_translateY.o" "shot1_cam.ty";
connectAttr "shot1_cam_translateZ.o" "shot1_cam.tz";
connectAttr "shot1_cam_rotateX.o" "shot1_cam.rx";
connectAttr "shot1_cam_rotateY.o" "shot1_cam.ry";
