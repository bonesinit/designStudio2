...
//Name: filingCabinetSet_WIP.0004.ma
//Last modified: Sun, Oct 18, 2020 01:14:14 PM
//Codeset: 1252
requires maya "2020";
...
fileInfo "UUID" "59C570A7-4356-2048-AB43-4C953BDCFA96";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.1617868242871632 5.0068696081092501 3.4179193067577183 ;
	setAttr ".r" -type "double3" -42.938352729595202 -13.399999999999837 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "4FDDBEA2-43D8-BCA7-8737-679DCAA51624";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 1000000;
	setAttr ".coi" 6.0567895482323664;
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "polyCloseBorder16.out" "filingCabinetSet_geoShape.i";
...
// End of filingCabinetSet_WIP.0004.ma
