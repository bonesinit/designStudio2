...
//Name: newEvilLair_ENV_WIP.0009.ma
//Last modified: Tue, Nov 03, 2020 02:54:11 PM
//Codeset: 1252
...
fileInfo "UUID" "BDD15695-479B-B8DD-2B5F-90845E077A8B";
createNode transform -s -n "persp";
	rename -uid "71DF941A-4172-4055-0B6C-0AAF6640B8FF";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.9270505081402254 22.94321830086605 18.294013850747078 ;
	setAttr ".r" -type "double3" -50.738352729642884 740.99999999999363 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "369DB1E5-49FE-EC23-766C-85B92232F289";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 1000000;
	setAttr ".coi" 20.698911903960568;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "DC9792CC-4D09-FAB8-CC17-64B98059A772";
	setAttr -s 25 ".lnk";
	setAttr -s 25 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "0AB310AF-496A-43BB-0D1C-BFB51DF7A1CD";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "168F744D-47A4-4D5F-C9EF-15B1ABCEF647";
createNode displayLayerManager -n "layerManager";
	rename -uid "D187BA2A-4415-BA9E-03D9-D68E46A77B26";
	setAttr ".cdl" 1;
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5D6F3F97-4841-55C4-7B95-B5AC3859AC4E";
...
// End of newEvilLair_ENV_WIP.0009.ma
