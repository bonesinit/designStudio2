...
//Name: lighting.ma
//Last modified: Thu, Nov 05, 2020 10:49:07 PM
//Codeset: 1252
...
fileInfo "UUID" "891893F9-458D-2873-DB6C-19989D22536B";
createNode transform -s -n "persp";
	rename -uid "F0644C6A-4262-38FA-08D6-3BA723F55F9D";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -20.072886636695344 39.111705238609574 15.126428275554122 ;
	setAttr ".r" -type "double3" -56.138352729803991 -1131.0000000001312 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "816FF9A1-4E9F-8AB1-8B65-F9A38122D87B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 46.518107767896801;
...
createNode transform -n "aiAreaLight11";
	...
	setAttr ".r" -type "double3" 286.81250061997042 -45.671464585655883 0 ;
...
createNode aiAreaLight -n "aiAreaLight11Shape" -p "aiAreaLight11";
	...
	setAttr ".ai_exposure" 2.9605262279510498;
	setAttr ".ai_spread" 0.32835820317268372;
	setAttr ".ai_translator" -type "string" "quad";
	setAttr ".aal" -type "attributeAlias" {"exposure","aiExposure","normalize","aiNormalize"
		} ;
...
createNode fosterParent -n "newEvilLair_envRNfosterParent1";
	rename -uid "3342DED4-4FB9-704A-D094-15B414AD5177";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "0CBD5DA7-4138-B980-966B-368BF985AB8D";
	setAttr -s 45 ".lnk";
	setAttr -s 45 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "6F82D210-4AC3-1F91-47FB-4C932A7C059B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B9650ABB-4F9F-91C3-5559-6499D4F5B5A6";
createNode displayLayerManager -n "layerManager";
	rename -uid "4B9F22FA-45AD-72E0-6FD5-C19D87920EC2";
createNode displayLayer -n "defaultLayer";
	rename -uid "EEDE5955-4BEB-F809-BE15-4C9D05C8E6F9";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C992F482-4BF7-C9DE-E5F4-A4AFA55C33E4";
