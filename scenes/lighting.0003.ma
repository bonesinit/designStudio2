...
//Name: lighting.0003.ma
//Last modified: Fri, Nov 06, 2020 12:04:31 PM
//Codeset: 1252
...
fileInfo "UUID" "C9769D5D-4708-E0E5-E962-C59B9F3604F9";
createNode transform -s -n "persp";
	rename -uid "F0644C6A-4262-38FA-08D6-3BA723F55F9D";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.4742970368744901 19.361424243556129 7.2794020781885669 ;
	setAttr ".r" -type "double3" -37.538352730123307 -1061.7999999996321 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "816FF9A1-4E9F-8AB1-8B65-F9A38122D87B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 18.966518768391147;
...
createNode transform -n "bookShelfRight_light" -p "objectLights_grp";
	...
	setAttr ".r" -type "double3" -90 0 22.969337050044317 ;
...
createNode transform -n "filingCabinet_light" -p "objectLights_grp";
	...
	setAttr ".t" -type "double3" -7.3717525403576021 7.2488455774427898 -6.7614814739454525 ;
	setAttr ".r" -type "double3" -62.898774070241039 -1.5902773407317588e-15 -26.196701295024752 ;
	setAttr ".s" -type "double3" 0.9463745575782061 0.9463745575782061 0.9463745575782061 ;
createNode aiAreaLight -n "filingCabinet_lightShape" -p "filingCabinet_light";
	...
	setAttr ".csh" no;
	setAttr ".rcsh" no;
	setAttr ".intensity" 1.2903225421905518;
	setAttr ".ai_exposure" 1;
	setAttr ".ai_spread" 0.34328359365463257;
	setAttr ".ai_translator" -type "string" "disk";
	setAttr ".aal" -type "attributeAlias" {"exposure","aiExposure","normalize","aiNormalize"
...
createNode aiLightBlocker -n "aiLightBlocker1" -p "cabinetBlocker_block";
	...
	setAttr ".dens" 0.26347306370735168;
createNode transform -n "wideRoomRight_render_cam";
...
createNode camera -n "wideRoomRight_render_camShape" -p "wideRoomRight_render_cam";
	...
	setAttr ".dfg" yes;
	setAttr ".ai_translator" -type "string" "perspective";
createNode transform -n "paintingPlant_render_cam";
...
createNode camera -n "paintingPlant_render_camShape" -p "paintingPlant_render_cam";
	...
	setAttr ".dfg" yes;
	setAttr ".ai_translator" -type "string" "perspective";
createNode transform -n "wideRoomLeft_render_cam";
