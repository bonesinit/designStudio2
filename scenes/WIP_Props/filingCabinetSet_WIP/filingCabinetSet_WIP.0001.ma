...
//Name: filingCabinetSet_WIP.0001.ma
//Last modified: Sun, Oct 18, 2020 11:51:34 AM
//Codeset: 1252
requires maya "2020";
...
fileInfo "UUID" "20C4B65E-4092-7802-06C3-2892946E0ACC";
...
createNode transform -n "ref" -p "DO_NOT_TOUCH";
	...
	setAttr ".t" -type "double3" 0 0 -1.928446542368061 ;
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.525945089430671 2.1965414087037733 8.0766762693391332 ;
	setAttr ".r" -type "double3" -9.9383527296096457 17.399999999997704 2.0831719395107972e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "4FDDBEA2-43D8-BCA7-8737-679DCAA51624";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 1000000;
	setAttr ".coi" 8.7154031460071142;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "FB12CAE8-439E-01E9-F3FE-6FAED569BD2A";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A46DB83A-47CE-94E2-4739-89BC0E71AED1";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "8ACC3CBE-4212-6A51-7F68-D9AF3843F662";
createNode displayLayerManager -n "layerManager";
	rename -uid "02AC9561-42F1-B0FD-25C0-F09023024A8B";
createNode displayLayer -n "defaultLayer";
	rename -uid "A7D1F44A-4A00-2C3B-74A5-9A904D48A8CE";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "63923608-4F86-A8E6-C4D6-E28059AD891D";
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "polyBridgeEdge6.out" "filingCabinetSet_geoShape.i";
...
// End of filingCabinetSet_WIP.0001.ma
