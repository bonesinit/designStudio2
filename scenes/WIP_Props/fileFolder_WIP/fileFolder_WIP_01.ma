...
//Name: fileFolder_WIP_01.ma
//Last modified: Thu, Oct 22, 2020 02:54:48 PM
//Codeset: 1252
requires maya "2020";
requires "mtoa" "4.0.0";
...
fileInfo "UUID" "F58AA94C-408E-3E82-1B95-B7B5D490C128";
...
createNode transform -s -n "persp";
	...
	setAttr ".t" -type "double3" 0.35502112713221334 -0.20806018016115868 -0.78073982437891987 ;
	setAttr ".r" -type "double3" 171.26164727484982 -356.19999999986396 359.9999999999996 ;
	setAttr ".rp" -type "double3" -5.5511151231257827e-17 0 0 ;
	setAttr ".rpt" -type "double3" 2.0484688627653569e-16 -1.2063090336076467e-16 -1.1719625881590151e-18 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "FBA13380-4259-2CDB-F0CD-FDA4B9EA02C0";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 1.0039046712379669;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.42388435630838001 -0.0033041403352504061 0.20128771938795809 ;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.34810113564252038 -0.019713626161573451 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "565229FA-436D-F0E8-A822-10882EA36F7C";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.0980074114831;
	setAttr ".ow" 1.687191775035227;
	setAttr ".imn" -type "string" "front";
	setAttr ".den" -type "string" "front_depth";
	setAttr ".man" -type "string" "front_mask";
	setAttr ".tp" -type "double3" 0.34810113564252038 -0.019713626161573451 0.0019925885169413959 ;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 0.52721636763735824;
...
createNode mesh -n "polySurfaceShape1" -p "polySurface1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.5833333432674408 0.5 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode transform -n "polySurface4";
	...
	setAttr ".s" -type "double3" 0.52330062625430507 0.0044641253345771821 -0.41134973402840869 ;
createNode mesh -n "polySurfaceShape4" -p "polySurface4";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.5138888955116272 1 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 2 ".pt";
	setAttr ".pt[26]" -type "float3" 0.0081347441 0.74193615 0.0002139656 ;
	setAttr ".pt[82]" -type "float3" 0.0081347441 0.74193615 0.0002139656 ;
	setAttr ".dr" 1;
	setAttr ".ai_translator" -type "string" "polymesh";
...
connectAttr "polyExtrudeFace2.out" "polySurfaceShape4.i";
