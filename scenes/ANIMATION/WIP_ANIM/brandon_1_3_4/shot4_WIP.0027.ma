...
//Name: shot4_WIP.0027.ma
//Last modified: Wed, Nov 11, 2020 02:53:29 PM
//Codeset: 1252
...
fileInfo "UUID" "E4D54DB0-47F5-2920-4D5B-12A67069D32E";
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 0 -max 166 -ast -25 -aet 200 ";
	setAttr ".st" 6;
...
createNode reference -n "goodGuy_rigRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"visibility" " 1"
		2 "|goodGuy_rig:Group|goodGuy_rig:Main|goodGuy_rig:MotionSystem|goodGuy_rig:IKSystem|goodGuy_rig:IKHandle|goodGuy_rig:IKOffsetLeg_R|goodGuy_rig:IKExtraLeg_R|goodGuy_rig:IKLeg_R" 
		"translate" " -type \"double3\" 0 0 -0.1287566100145397"
		2 "|goodGuy_rig:Group|goodGuy_rig:Main|goodGuy_rig:MotionSystem|goodGuy_rig:IKSystem|goodGuy_rig:IKHandle|goodGuy_rig:IKOffsetLeg_R|goodGuy_rig:IKExtraLeg_R|goodGuy_rig:IKLeg_R" 
		"translateX" " -av"
		2 "|goodGuy_rig:Group|goodGuy_rig:Main|goodGuy_rig:MotionSystem|goodGuy_rig:IKSystem|goodGuy_rig:IKHandle|goodGuy_rig:IKOffsetLeg_R|goodGuy_rig:IKExtraLeg_R|goodGuy_rig:IKLeg_R" 
		"translateY" " -av"
		...
		"visibility" " 1"
		2 "|goodGuy_rig:Group|goodGuy_rig:Main|goodGuy_rig:MotionSystem|goodGuy_rig:IKSystem|goodGuy_rig:IKHandle|goodGuy_rig:IKOffsetLeg_L|goodGuy_rig:IKExtraLeg_L|goodGuy_rig:IKLeg_L" 
		"translate" " -type \"double3\" -0.043754083973180258 0 0.26601175383909237"
		2 "|goodGuy_rig:Group|goodGuy_rig:Main|goodGuy_rig:MotionSystem|goodGuy_rig:IKSystem|goodGuy_rig:IKHandle|goodGuy_rig:IKOffsetLeg_L|goodGuy_rig:IKExtraLeg_L|goodGuy_rig:IKLeg_L" 
		"translateX" " -av"
		2 "|goodGuy_rig:Group|goodGuy_rig:Main|goodGuy_rig:MotionSystem|goodGuy_rig:IKSystem|goodGuy_rig:IKHandle|goodGuy_rig:IKOffsetLeg_L|goodGuy_rig:IKExtraLeg_L|goodGuy_rig:IKLeg_L" 
		"translateY" " -av"
...
createNode animCurveTL -n "IKLeg_R_translateZ";
	...
	setAttr ".tan" 18;
	setAttr -s 9 ".ktv[0:8]"  1 -0.13 20 0.279 40 -0.13 60 0.28 80 -0.13966091409386389
		 100 0.2900718619382528 120 -0.12231309506141974 140 0.29007186193825285 160 -0.1287566100145397;
	setAttr -s 9 ".kit[2:8]"  1 18 18 18 18 18 18;
	setAttr -s 9 ".kot[2:8]"  1 18 18 18 18 18 18;
	setAttr -s 9 ".kix[2:8]"  0.75690469457083864 0.83333333333333326 
		0.83333333333333348 0.83333333333333348 0.83333333333333304 0.83333333333333304 0.83333333333333393;
	setAttr -s 9 ".kiy[2:8]"  -0.049965819597620954 0 0 0 0 0 0;
	setAttr -s 9 ".kox[2:8]"  0.75690475707235905 0.83333333333333348 
		0.83333333333333348 0.83333333333333304 0.83333333333333304 0.83333333333333393 0.83333333333333393;
	setAttr -s 9 ".koy[2:8]"  -0.049965787986284843 0 0 0 0 0 0;
createNode animCurveTL -n "IKLeg_L_translateZ";
	rename -uid "C2DC099B-4797-622F-FCDD-A38ABB1F5BAE";
	setAttr ".tan" 18;
	setAttr -s 7 ".ktv[0:6]"  1 0.25 20 -0.30797841130854875 40 0.26451753507136794
		 60 -0.29748563854825882 80 0.26601175383909237 100 -0.31100957596555523 120 0.26601175383909237;
	setAttr -s 7 ".kit[2:6]"  1 18 18 18 18;
	setAttr -s 7 ".kot[2:6]"  1 18 18 18 18;
	setAttr -s 7 ".kix[2:6]"  0.66187180634831089 0.83333333333333326 
		0.83333333333333348 0.83333333333333348 0.83333333333333304;
	setAttr -s 7 ".kiy[2:6]"  -0.0011792076416709632 0 0 0 0;
	setAttr -s 7 ".kox[2:6]"  0.66187183127834182 0.83333333333333348 
		0.83333333333333348 0.83333333333333304 0.83333333333333304;
	setAttr -s 7 ".koy[2:6]"  -0.0011791635491831701 0 0 0 0;
...
connectAttr "IKLeg_R_translateZ.o" "goodGuy_rigRN.phl[30]";
connectAttr "IKLeg_R_roll.o" "goodGuy_rigRN.phl[31]";
connectAttr "RollHeel_R_translateX.o" "goodGuy_rigRN.phl[32]";
connectAttr "RollHeel_R_translateY.o" "goodGuy_rigRN.phl[33]";
connectAttr "RollHeel_R_translateZ.o" "goodGuy_rigRN.phl[34]";
connectAttr "RollToesEnd_R_translateY.o" "goodGuy_rigRN.phl[35]";
connectAttr "IKToes_R_rotateX.o" "goodGuy_rigRN.phl[36]";
connectAttr "PoleLeg_R_translateX.o" "goodGuy_rigRN.phl[37]";
connectAttr "PoleLeg_R_translateY.o" "goodGuy_rigRN.phl[38]";
connectAttr "PoleLeg_R_translateZ.o" "goodGuy_rigRN.phl[39]";
connectAttr "IKLeg_L_translateZ.o" "goodGuy_rigRN.phl[40]";
connectAttr "IKLeg_L_roll.o" "goodGuy_rigRN.phl[41]";
connectAttr "RollHeel_L_translateX.o" "goodGuy_rigRN.phl[42]";
connectAttr "RollHeel_L_translateY.o" "goodGuy_rigRN.phl[43]";
connectAttr "RollHeel_L_translateZ.o" "goodGuy_rigRN.phl[44]";
connectAttr "RollHeel_L_rotateX.o" "goodGuy_rigRN.phl[45]";
connectAttr "RollHeel_L_rotateY.o" "goodGuy_rigRN.phl[46]";
connectAttr "RollHeel_L_rotateZ.o" "goodGuy_rigRN.phl[47]";
connectAttr "RollToesEnd_L_translateX.o" "goodGuy_rigRN.phl[48]";
connectAttr "RollToesEnd_L_translateY.o" "goodGuy_rigRN.phl[49]";
connectAttr "RollToesEnd_L_translateZ.o" "goodGuy_rigRN.phl[50]";
connectAttr "RollToesEnd_L_rotateX.o" "goodGuy_rigRN.phl[51]";
connectAttr "RollToesEnd_L_rotateY.o" "goodGuy_rigRN.phl[52]";
connectAttr "RollToesEnd_L_rotateZ.o" "goodGuy_rigRN.phl[53]";
connectAttr "IKToes_L_rotateX.o" "goodGuy_rigRN.phl[54]";
connectAttr "RootX_M_translateX.o" "goodGuy_rigRN.phl[55]";
connectAttr "RootX_M_translateY.o" "goodGuy_rigRN.phl[56]";
connectAttr "Fingers_R_indexCurl.o" "goodGuy_rigRN.phl[57]";
connectAttr "Fingers_R_middleCurl.o" "goodGuy_rigRN.phl[58]";
connectAttr "Fingers_R_ringCurl.o" "goodGuy_rigRN.phl[59]";
connectAttr "Fingers_R_pinkyCurl.o" "goodGuy_rigRN.phl[60]";
connectAttr "Fingers_R_thumbCurl.o" "goodGuy_rigRN.phl[61]";
connectAttr "Fingers_R_spread.o" "goodGuy_rigRN.phl[62]";
connectAttr "Fingers_R_cup.o" "goodGuy_rigRN.phl[63]";
connectAttr "Fingers_L_indexCurl.o" "goodGuy_rigRN.phl[64]";
connectAttr "Fingers_L_middleCurl.o" "goodGuy_rigRN.phl[65]";
connectAttr "Fingers_L_ringCurl.o" "goodGuy_rigRN.phl[66]";
connectAttr "Fingers_L_pinkyCurl.o" "goodGuy_rigRN.phl[67]";
connectAttr "Fingers_L_thumbCurl.o" "goodGuy_rigRN.phl[68]";
connectAttr "Fingers_L_spread.o" "goodGuy_rigRN.phl[69]";
connectAttr "Fingers_L_cup.o" "goodGuy_rigRN.phl[70]";
