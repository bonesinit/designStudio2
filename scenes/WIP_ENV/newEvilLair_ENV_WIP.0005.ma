...
//Name: newEvilLair_ENV_WIP.0005.ma
//Last modified: Mon, Nov 02, 2020 07:12:22 PM
//Codeset: 1252
...
fileInfo "UUID" "64C058F3-429C-5F0A-44BD-EBA6950B0F59";
createNode transform -s -n "persp";
	rename -uid "71DF941A-4172-4055-0B6C-0AAF6640B8FF";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.2591304636813128 45.80343810536008 13.547835730739131 ;
	setAttr ".r" -type "double3" -63.33835272962213 379.79999999992714 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "369DB1E5-49FE-EC23-766C-85B92232F289";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 1000000;
	setAttr ".coi" 48.76180501973024;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C692EC38-4452-5489-B6CB-9D97F0106026";
	setAttr -s 11 ".lnk";
	setAttr -s 11 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "0D3AA833-4785-ECAB-AF88-36AB3452D7FE";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "272D4E29-47C3-4DFA-0764-CCB88FA90F6B";
createNode displayLayerManager -n "layerManager";
	rename -uid "92CCC218-40AF-BFD5-4208-41931B0638DC";
	setAttr ".cdl" 1;
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "85F8D5FF-4963-32FA-025C-7B90A6A78114";
...
createNode reference -n "filingCabinetSetRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotatePivot" " -type \"double3\" -0.014975002071783372 0.38540817733253485 -0.27502429485321223"
		
		2 "|filingCabinetSet:filingCabinetSet_grp|filingCabinetSet:POSITION|filingCabinetSet:MOVEMENT|filingCabinetSet:ADJUSTMENTS|filingCabinetSet:DO_NOT_TOUCH|filingCabinetSet:drawer_8_geo" 
		"scalePivot" " -type \"double3\" -0.014975002071783372 0.38540817733253485 -0.27502429485321223"
...
createNode reference -n "filingCabinetSetRN2";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"visibility" " 1"
		2 "|filingCabinetSet2:filingCabinetSet_grp|filingCabinetSet2:POSITION|filingCabinetSet2:MOVEMENT|filingCabinetSet2:ADJUSTMENTS|filingCabinetSet2:DO_NOT_TOUCH|filingCabinetSet2:drawer_ctrl" 
		"rotatePivot" " -type \"double3\" -0.67633695969519181 1.42329080118190943 0.80288803577422918"
		
		2 "|filingCabinetSet2:filingCabinetSet_grp|filingCabinetSet2:POSITION|filingCabinetSet2:MOVEMENT|filingCabinetSet2:ADJUSTMENTS|filingCabinetSet2:DO_NOT_TOUCH|filingCabinetSet2:drawer_ctrl" 
		"scalePivot" " -type \"double3\" -0.67633695969519048 1.42329080118190943 0.80288803577423451"
		...
		"rotatePivot" " -type \"double3\" -0.014975002071786925 0.38540817733253485 -0.27502429485321045"
		
		2 "|filingCabinetSet2:filingCabinetSet_grp|filingCabinetSet2:POSITION|filingCabinetSet2:MOVEMENT|filingCabinetSet2:ADJUSTMENTS|filingCabinetSet2:DO_NOT_TOUCH|filingCabinetSet2:drawer_8_geo" 
		"scalePivot" " -type \"double3\" -0.014975002071786925 0.38540817733253485 -0.27502429485321045"
...
// End of newEvilLair_ENV_WIP.0005.ma
