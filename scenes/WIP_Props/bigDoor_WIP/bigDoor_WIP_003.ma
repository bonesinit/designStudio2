...
//Name: bigDoor_WIP_003.ma
//Last modified: Sun, Nov 01, 2020 04:27:45 PM
//Codeset: 1252
requires maya "2019";
requires "mtoa" "3.1.2";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.52668732098273674 8.8902699977000026 7.1494293055000266 ;
	setAttr ".r" -type "double3" -45.338352727244704 -724.1999999999498 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "0EF72EA0-4E5E-0DA5-08F3-50B13494FDFC";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 12.110540724462638;
...
createNode transform -n "pPlane1";
	rename -uid "5620F027-4918-83C0-A997-68B0AEBD621F";
	setAttr ".t" -type "double3" 0 2.73 0 ;
	setAttr ".r" -type "double3" 90 0 -90 ;
	setAttr ".s" -type "double3" 5.4641488650637218 1 11.114870903626104 ;
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	rename -uid "87C09A71-41F2-1741-319A-04ACE83E6EB4";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode polyPlane -n "polyPlane1";
	rename -uid "40721526-4761-AE6A-2F3F-3B836486E63D";
	setAttr ".cuv" 2;
createNode displayLayer -n "layer1";
	rename -uid "8115E413-4A99-B2A9-ACB3-DA8045275B16";
	setAttr ".dt" 1;
	setAttr ".do" 1;
select -ne :time1;
	setAttr ".o" 1;
