...
//Name: shot6.ma
//Last modified: Fri, Nov 20, 2020 06:29:12 PM
//Codeset: 1252
...
fileInfo "UUID" "1B341ED4-463A-534B-8B74-A1851437D1AE";
...
createNode transform -n "shot6_cam";
	...
	setAttr ".t" -type "double3" -1.6573688986993325 1.771140588358223 -4.4705901271419721 ;
	setAttr -l on ".tx";
	setAttr -l on ".ty";
	setAttr -l on ".tz";
	setAttr ".r" -type "double3" -5.4000000000001522 -101.1999999999997 -1.0319372577590567e-16 ;
	setAttr -l on ".ry";
createNode camera -n "shot6_camShape" -p "shot6_cam";
	...
	setAttr ".ff" 0;
	setAttr ".ovr" 1.3;
	setAttr -l on ".coi" 2.0192321585827164;
	setAttr -l on ".ow" 30;
...
createNode reference -n "Villain_rigRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|Villain_rig:Group|Villain_rig:Main" "translate" " -type \"double3\" 1.16313971742262368 -0.054699616102863058 -3.77967272437430335"
...
createNode animCurveTA -n "shot6_cam_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  80 -5.4000000000001522 100 -13.200000000000237;
select -ne :time1;
	setAttr -k on ".cch";
	setAttr -k on ".nds";
	setAttr ".o" 80;
