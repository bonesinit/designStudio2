...
//Name: filingCabinetSet_WIP.0005.ma
//Last modified: Sun, Oct 18, 2020 01:17:45 PM
//Codeset: 1252
requires maya "2020";
...
fileInfo "UUID" "C32C1424-4069-12E7-F9E8-57A1A6C7D6AA";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.3389987170099378 3.8010108462687411 3.5964717064990164 ;
	setAttr ".r" -type "double3" -35.73835272958236 -698.5999999999475 -4.2700913136424024e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "4FDDBEA2-43D8-BCA7-8737-679DCAA51624";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 1000000;
	setAttr ".coi" 5.049169906807883;
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "deleteComponent1.og" "filingCabinetSet_geoShape.i";
...
connectAttr "polyCloseBorder16.out" "polyDelEdge1.ip";
...
connectAttr "polyDelEdge69.out" "polyDelEdge70.ip";
connectAttr "polyDelEdge70.out" "polyDelEdge71.ip";
connectAttr "polyDelEdge71.out" "polyDelEdge72.ip";
connectAttr "polyDelEdge72.out" "deleteComponent1.ig";
...
// End of filingCabinetSet_WIP.0005.ma
